...
public final class Model
{
	...
	public Model(Controller controller)
	{
		...
		properties.put("myString",		"5.0");
		properties.put("myTitleString",		"Enter Title Here");
		properties.put("myDirString",		"Enter Director Here");
		properties.put("myYearString",		"2020");
		properties.put("summaryTextAreaString",		"Write Summary Here: Up to 10 Lines");
		properties.put("commentTextAreaString",		"");
		properties.put("myRatingBoxString",		"");
		properties.put("myActingBoxString",		"");
		properties.put("myCinBoxString",		"");
		properties.put("myDirBoxString",		"");
		properties.put("myPicBoxString",		"");
		properties.put("myAnimatedCheckBoxString",		"");
		properties.put("myColorCheckBoxString",		"");
		properties.put("myPosterPathText",		"Poster Path");
